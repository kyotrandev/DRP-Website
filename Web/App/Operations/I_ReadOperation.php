...
interface I_ReadOperation { 
  static function getSingleObjectById(int $id, bool $ignoreActiveStatus = false) : mixed;
  ...
  static function getAllObjectsByFieldAndValue(string $columnName, $value, bool $ignoreActiveStatus = false) : mixed;
